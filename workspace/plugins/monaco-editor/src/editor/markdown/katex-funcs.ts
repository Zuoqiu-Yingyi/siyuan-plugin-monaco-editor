...
/**
 * REF: https://katex.org/docs/supported
 */
...
// REF: https://katex.org/docs/supported#html
export const html1 = [
    'url',
];
...
/**
 * REF: https://github.com/yzhang-gh/vscode-markdown/blob/master/src/util/katex-funcs.ts
 * version: 3.4.0
 */
