...
* 更新思源插件 API 定义文件 | Update SiYuan plugin API definition file. ([75f0c09](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/75f0c09b1362e0094f41cb1fa75b5483981f765d))
...
* **open-api:** release v1.0.2 ([025db9c](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/025db9cd0f2ba3696770a511d0d654521d0b67e0))
...
* **webview:** release v1.0.1 ([de89d32](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/de89d325f4a8136a5382273c8c601138cc8431d1))
...
* **open-api:** 修复 `build.yml` CD 配置 | Fix `build.yml` CD configuration. ([dc9c87c](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/dc9c87cf68935dd1687a71b679a604bf8ed58b4e))
...
* 添加捐助方案 | Added donation method. ([afe4bdd](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/afe4bdd71711755802604b60472c8c1b4db972a9))
...
* **custom-block:** 新增显示块序号功能 | Add display block index function. ([5b92104](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/5b92104e6b0e49d7583e81baf5dccfbf1044a5f4))
...
* **monaco-editor:** 添加代码片段编辑菜单 | Add code snippet edit menu. ([f125283](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/f12528313e421d19e4db01084d1f6c156dd0a890))
...
* **webview:** `webview` 插件支持使用配置选项控制其行为 | The `webview` plugin supports using configuration to control its behavior. ([03b8c75](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/03b8c75904fb4ef3aed6a1d05466a445153640e6))
...
* **webview:** 添加 `使用新窗口打开思源编辑器` 功能 | Add `Open SiYuan Editor in a new window` function. ([6d95f35](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/6d95f35912f4e0bd714c5e578d7580df0edaebcd))
...
* 添加文件资源管理面板 | Add file resource management panel. ([972c513](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/972c5133dfbfe9518be9b0071b95424f41a59dac))
...
* 添加浏览位置属性编辑功能 | Add browser location attribute edit function. ([ac9a4d5](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/ac9a4d565007f5b40c19f1fe21ebc9331233bea8))
* 添加自定义属性编辑功能 | Add custom attributes edit function. ([1116f6a](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/1116f6a1e6cc32c0a6837c536b691e5330fe380a))
* 添加附属仓库 `siyuan-plugin-webview` | Add sub-repository `siyuan-plugin-webview`. ([dd5b98b](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/dd5b98bb829cc5b4961cfdd90e8230b0c7675127))
* 添加附属仓库 `siyuan-plugin-webview` | Add sub-repository `siyuan-plugin-webview`. ([3f0da37](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/3f0da3796fbc6614aeeccd9d83ee2f037b120de7))


### Bug Fixes

* **components:** 修复提示框方向异常问题 | Fix the issue of abnormal direction of prompt box. ([13c7dee](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/13c7dee0e5c5b2e8900da4e9162f078ae5bed79c))
* **components:** 修复设置面板无法完全填充问题 | Fix the issue that the settings panel cannot be fully filled. ([6f60f22](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/6f60f222349c63c0c8a4840b2c5311a6cf82694f))
* **components:** 修复设置面板无法完全填充问题 | Fix the issue that the settings panel cannot be fully filled. ([bf9eb18](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/bf9eb180ec6b02a0379f6f15650367036e81a7f2))
* **monaco-editor:** 修复拖动页签分栏时编辑器无法重新加载问题 | Fix the issue that the editor cannot be reloaded when dragging the tab to split the screen. ([6f16d87](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/6f16d87cddf7c1e3e716b9dd4cbaca9454821168))
* **webview:** 修复在非安全上下文中无法使用 `crypto.randomUUID` 的问题 | Fix the issue that `crypto.randomUUID` cannot be used in an insecure context. ([0d6b387](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/0d6b387191f0fc25c1585d90a4dec41cb2878924))
* **webview:** 修复在非安全上下文中无法使用 `crypto.randomUUID` 的问题 | Fix the issue that `crypto.randomUUID` cannot be used in an insecure context. ([504f7d7](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/504f7d7b8994066d5cafccc29bef5753335e9adb))
* **webview:** 修复拖拽分屏失效问题 | Fix the issue that drag and drop split screen is invalid. ([c32ec02](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/c32ec02e4d89b7c22ce23ac8488c8df391a6784d))
* **webview:** 修复拖拽分屏失效问题 | Fix the issue that drag and drop split screen is invalid. ([b5d9f26](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/b5d9f267043503ecdd997a786fe1dad9945fe35b))
* **webview:** 修复菜单栏状态设置失效问题 | Fix the issue that the menu bar status setting is invalid. ([47d9f38](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/47d9f38ccfc9c10bd7103d68c1e31ea5ec04bf8a))
* **webview:** 修复菜单栏状态设置失效问题 | Fix the issue that the menu bar status setting is invalid. ([28ba15e](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/28ba15edfc8743437849b76a83dd3b6ea2b72d32))
* **webview:** 修复页签图标未显示问题 | Fix the issue of tab icon not displayed. ([ca43c09](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/ca43c09bdc6dc98accb9abee06c02517eccf9ea7))
* **webview:** 修复页签图标未显示问题 | Fix the issue of tab icon not displayed. ([dc7228e](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/dc7228eda27e90be786152c43786fc336d31339a))
* 转义文档别名中的 `,` | Escape `,` in document alias. ([d766239](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/d766239a5e7991a158fe54a12e234c639d3e4366))


### Performance Improvements

* **components:** 设置面板组件兼容 `v2.9.4` | Settings panel component compatible with `v2.9.4`. ([2829ee9](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/2829ee99ebe993db942e34a749aec96306da43af))
* **monaco-editor:** 优化编辑器另存为选项 | Optimize editor save as option. ([f03bc1e](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/f03bc1e02c9a3040205dba56f57f4bfa242d008e))
* **monaco-editor:** 支持使用设置项控制上下文菜单 | Support using setting items to control context menus. ([b91fc63](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/b91fc6363c9dd804851caf5ce7651b9898ef5ade))
* 改进设置对话框标题内容 | Improve the title content of the settings dialog. ([cc2a9aa](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/cc2a9aadfea66e1659fd2bc53302978b719e0f3d))
* 改进设置对话框标题内容 | Improve the title content of the settings dialog. ([6c31975](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/6c31975c1c91781e528868ae1c903fa6be5ee9ef))


### Code Refactoring

* **components:** 优化 BlockIcon 组件 | Optimize BlockIcon component. ([a1669ff](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/a1669ff9fccb58e4a0e82e19ed2948bc68abb6b5))
* **components:** 使用封装后的 `Svg.svelte` 组件 | Use the encapsulated `Svg.svelte` component. ([3648da3](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/3648da342a3a90fdcf130fd0433b85de360b3f2d))
* **components:** 使用封装后的 `Svg.svelte` 组件 | Use the encapsulated `Svg.svelte` component. ([52c3e39](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/52c3e39cc7609dff1d8a47c3118e424bed57afe3))
* **monaco-editor:** 调整文件资源管理器图标与提示文本 | Adjust the icon and prompt text of the file explorer. ([32fff26](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/32fff26498754350c7cc4304fc37aca9425c9c8f))
* **monaco-editor:** 重构侧边栏组件 | Refactor sidebar component. ([6f9b136](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/6f9b1365204428384491dfe47dabb66baa791483))
* **webview:** 使用 `svelte` 重构 `webview` | Refactor `webview` with `svelte`. ([3411718](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/3411718fe3db20c5833330d4ab9bd5dbd273dc0d))
* **webview:** 使用 `svelte` 重构 `webview` | Refactor `webview` with `svelte`. ([3e0edae](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/3e0edae3bcab7cacad034b373bac1139c1590be1))
* **webview:** 调整在新窗口打开触发策略 | Adjust the trigger strategy for opening in a new window. ([b9e8b5d](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/b9e8b5df75b0a3a6329da996239fd20cf6b2f4a8))
* **webview:** 调整在新窗口打开触发策略 | Adjust the trigger strategy for opening in a new window. ([577a724](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/577a724fc2a79acca1c90cbd56a18c8afed64fc6))
* 优化设置面板组件 | Optimize the settings panel component. ([f694a0f](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/f694a0fb70289e70ad671f40c30ad86afb0fe186))
* 优化设置面板组件 | Optimize the settings panel component. ([608ae84](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/608ae84663930b621fc80564175fc9c3edcec0e8))
* 使用 `&lt;webview&gt;` 原生 API 管理历史 ([bda1338](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/bda133853cca9adbd0b32bf0762e8e9b27f0a450))
* 重构 `apis.siyuan` | Refactor `apis.siyuan`. ([a102e9f](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/a102e9f94a06ab81258f932950712fece1117477))
* 重构 `apis.siyuan` | Refactor `apis.siyuan`. ([43d97e0](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/43d97e0c793607b9847816f440d44e17ce0e5ed9))


### Reverts

* 无效的 `build.yml` 触发条件 | Invalid trigger condition of `build.yml`. ([298e2de](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/298e2de2f400f18cffb15496c6c4ecd0c01a0821))
* 无效的 `build.yml` 触发条件 | Invalid trigger condition of `build.yml`. ([375c50b](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/375c50bb1d106490780eac8b3c4892ef84eb804e))


### Styles

* 调整响应式布局样式 | Adjust responsive layout style. ([3f69fa7](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/3f69fa71c5721b89ea113b70aca7b7e6028d5680))
* 调整响应式布局样式 | Adjust responsive layout style. ([ce1be96](https://github.com/Zuoqiu-Yingyi/siyuan-plugin-monaco-editor/commit/ce1be9640aa940b8d05e792f7833fe16b086aa7e))
